...
test('IDC: CT with negative SpacingBetweenSlices Test', async t => {
  ...
  t.deepEqual(outputImage.origin, [ -171, -102, 673.300049 ])
  t.deepEqual(outputImage.spacing, [ 0.671875, 0.671875, 4.0 ])
  t.assert(arrayEquals(outImage.direction, [ 1, 0, 0, 0, 1, 0, 0, 0, -1 ]))
  t.deepEqual(outImage.size, [ 512, 512, 89 ])
  t.deepEqual(outImage.data.length, 23330816)
})
