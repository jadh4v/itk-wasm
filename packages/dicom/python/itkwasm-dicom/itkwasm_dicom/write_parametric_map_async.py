...
async def write_parametric_map_async(
    ...
    """
    func = environment_dispatch("itkwasm_dicom", "write_parametric_map_async")
    output = await func(paramap_image, meta_info, output_dicom_file, ref_dicom_series=ref_dicom_series)
    return output
